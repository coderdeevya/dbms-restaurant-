	...
	?>
		...
		<!-- Banner -->
			<section id="banner" class="wrapper">
				<div class="container">
				<h2>Bon Appetit Resto</h2>
				<p>Authentic taste just a click away!</p>
				<br><br>
				<center>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">Bon Appetit Resto &copy; </h3>
		<!--	<div class="logo">
				<a href="index.php"><img src="images/logo.png" width="200px"></a>
			</div>-->
			<br />
			<p style="font-size:20px;color:white">Authentic tastes and world cuisines!!!</p>
			<br />
		</div>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Bon Appetit Resto<span>Vormir</span></p>
			</div>
			<div>
		...
		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About ou Resto</b></span>
				Bon Appetit is a place where we excel in world cuisines and customers have been loving us for years...!
			</p>
