...
<html>
<head>
	<title>Bon Appetit: dishes</title>
	<meta lang="eng">
	<meta charset="UTF-8">
						...
						<div class="container">
							<div class="row">
								...
								<div class="col-12 col-sm-6">
									...
									<p style="font: 30px Times new roman;">Dish Chef : <?= $frow['fname']; ?></p>
                            ...
                            <center>
                                <div class="row uniform">
                                    <div class="6u 12u$(large)">
                                        <a href="myCart.php?flag=1&pid=<?= $pid; ?>" class="btn btn-primary" style="text-decoration: none;"><span class="glyphicon glyphicon-shopping-cart"> AddToOrders</a>
                                    </div>
                                    <div class="6u 12u$(large)">
